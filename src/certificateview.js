      ...
      <div id="download-pdf" className="flex flex-col items-center">
        <div className="certificate-container" id="certificate-container">
          ...
          <div className="contact">
            <table style={{ width: "100%", margin: "0 auto", borderSpacing: "0", borderCollapse: "collapse" }}>
              <tbody>
                <tr>
                  <td style={{ textAlign: "center" }}>
                    ...
                    <span style={{ verticalAlign: "middle" }}>akhandasevasamsthan.ass@gmail.com</span>
                    ...
                    <a href="https://www.akhandasevasamsthan.org/" style={{ textDecoration: "none", color: "inherit", verticalAlign: "middle" }}>www.akhandasevasamsthan.org</a>
                  </td>
                </tr>
                <tr>
